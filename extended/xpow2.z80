...
;!!!! If not, we'll need to check if the input is negative, add 1, decrement DE
  ...
  ld de,xexp_p12
  call xmul
  ld de,xexp_p11 \ call +_
  ld de,xexp_p10 \ call +_
  ld de,xexp_p9 \ call +_
  ld de,xexp_p8 \ call +_
  ld de,xexp_p7 \ call +_
  ld de,xexp_p6 \ call +_
  ld de,xexp_p5 \ call +_
  ld de,xexp_p4 \ call +_
  ld de,xexp_p3 \ call +_
  ld de,xexp_p2 \ call +_
  ld de,xexp_p1 \ call +_
